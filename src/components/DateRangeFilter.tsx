...
const OPTIONS: { label: string; shortLabel: string; value: DateRange }[] = [
  ...
  { label: "Work Week", shortLabel: "Work", value: "workweek" },
        ...
        <div className="flex items-center gap-1 p-1 rounded-xl glass w-fit">
          {OPTIONS.map((opt) => (
            <button
              ...
              className="relative px-2.5 sm:px-4 py-1.5 rounded-lg text-xs sm:text-sm font-medium transition-colors whitespace-nowrap"
